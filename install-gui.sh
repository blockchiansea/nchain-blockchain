...
if [ "$(id -u)" = 0 ]; then
  echo "The NChain Blockchain GUI can not be installed or run by the root user."
  exit 1
fi

# Allows overriding the branch or commit to build in nchain-blockchain-gui
SUBMODULE_BRANCH=$1
...
# https://github.com/blockchiansea/nchain-blockchain/pull/10460#issuecomment-1054492495
...
echo ""
echo "NChain blockchain install-gui.sh completed."
echo ""
