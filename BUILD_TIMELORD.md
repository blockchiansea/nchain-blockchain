...
required to run a [Timelord](https://github.com/blockchiansea/nchain-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/blockchiansea/nchain-blockchain/blob/main/install-timelord.sh)
