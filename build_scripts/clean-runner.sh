...
rm -rf ../venv || true
rm -rf venv || true
rm -rf nchain_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf nchain-blockchain-gui/build || true
rm -rf nchain-blockchain-gui/daemon || true
rm -rf nchain-blockchain-gui/node_modules || true
rm nchain-blockchain-gui/temp.json || true
(cd "$PWD/nchain-blockchain-gui" && git checkout HEAD -- package-lock.json) || true
cd "$PWD" || true
