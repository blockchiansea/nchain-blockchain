import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@nchain-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@nchain-network/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for NCH, CATs, or
