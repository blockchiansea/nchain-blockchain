import { WalletType, type Wallet } from '@nchain-network/api';
import { useGetCatListQuery } from '@nchain-network/api-react';
import { Flex, TooltipIcon, useCurrencyCode } from '@nchain-network/core';
import { CrCat } from '@nchain-network/icons';
