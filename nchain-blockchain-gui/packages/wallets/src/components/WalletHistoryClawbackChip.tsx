import { TransactionType } from '@nchain-network/api';
import type { Transaction } from '@nchain-network/api';
import { useGetAutoClaimQuery, useGetTimestampForHeightQuery, useGetHeightInfoQuery } from '@nchain-network/api-react';
import { useTrans, Button } from '@nchain-network/core';
