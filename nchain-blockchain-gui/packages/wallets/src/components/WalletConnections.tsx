import { Connection, ServiceConnectionName } from '@nchain-network/api';
import { useGetWalletConnectionsQuery } from '@nchain-network/api-react';
import { Card, FormatBytes, Loading, Table } from '@nchain-network/core';
