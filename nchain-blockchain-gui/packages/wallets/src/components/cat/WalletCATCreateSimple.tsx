import type { CATToken } from '@nchain-network/api';
import { SyncingStatus } from '@nchain-network/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@nchain-network/api-react';
import { Back, Flex, Loading, useShowError } from '@nchain-network/core';
