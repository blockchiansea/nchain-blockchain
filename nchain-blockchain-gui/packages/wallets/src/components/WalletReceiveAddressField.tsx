import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@nchain-network/api-react';
import { Color, Flex, Loading, truncateValue, useColorModeValue } from '@nchain-network/core';
import { Reload } from '@nchain-network/icons';
