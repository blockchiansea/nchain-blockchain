...
describe('calculateRoyalties', () => {
  describe('#royaltyAssetFromNFTInfo', () => {
    ...
    it('converts ext9 NFTInfo to a RoyaltyCalculationRoyaltyAsset object', () => {
      ...
      expect(royaltyAsset.royaltyAddress).toBe('nch17mp20xhhy7l6m20u37nw4ft338r2tt2yquenu4earcyzjwqh6kkswn9juu');
      expect(royaltyAsset.royaltyPercentage).toBe(350);
    });
    it('converts ext9 NFTInfo to a RoyaltyCalculationRoyaltyAsset object, ext9 as default', () => {
    ...
    it('converts testnet NFTInfo to a RoyaltyCalculationRoyaltyAsset object', () => {
      ...
      expect(royaltyAsset.asset).toBe('nft1g9xfeujpq402dhxrms5wqvh73rr02remvwvycr9s4cxzzlkg324s3nu8vj');
      expect(royaltyAsset.royaltyAddress).toBe('tnch17mp20xhhy7l6m20u37nw4ft338r2tt2yquenu4earcyzjwqh6kksr5zya0');
      expect(royaltyAsset.royaltyPercentage).toBe(350);
    });
  });
