import { toBech32m, WalletType } from '@nchain-network/api';
import { mojoToChia, mojoToCAT } from '@nchain-network/core';
      ...
      if (asset) {
        switch (asset.walletType) {
          case WalletType.STANDARD_WALLET:
            section.nch.push({ amount: mojoToChia(numericValue.abs()).toFixed() });
            break;
          case WalletType.CAT:
