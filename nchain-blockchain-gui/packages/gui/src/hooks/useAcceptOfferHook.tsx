import type { OfferSummaryRecord, Wallet } from '@nchain-network/api';
import { useTakeOfferMutation } from '@nchain-network/api-react';
import { AlertDialog, chiaToMojo, useOpenDialog, useShowError } from '@nchain-network/core';
