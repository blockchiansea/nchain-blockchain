...
import { useGetCatListQuery, useGetWalletsQuery } from '@nchain-network/api-react';
import type { CATToken, Wallet } from '@nchain-network/core';
...
export default function useAssetIdName() {
  ...
  const memoized = useMemo(() => {
    ...
    // If using testnet, add a TNCH assetId entry
