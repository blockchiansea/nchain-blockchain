...
import { NFTInfo } from '@nchain-network/api';
...
import AppIcon from '../assets/img/nchain64x64.png';
...
// At that time, the config file is created here by `nchain init`.
if (!checkConfigFileExists()) {
  chiaInit();
}

// Set the userData directory to its location within NCHAIN_ROOT/gui
setUserDataDir();
...
function getMenuTemplate() {
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'NChain Blockchain Wiki' }),
          click: () => {
            openExternal('https://github.com/blockchiansea/nchain-blockchain/wiki');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
          click: () => {
            openExternal('https://github.com/blockchiansea/nchain-blockchain/wiki/FAQ');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Release Notes' }),
          click: () => {
            openExternal('https://github.com/blockchiansea/nchain-blockchain/releases');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
          click: () => {
            openExternal('https://github.com/blockchiansea/nchain-blockchain/blob/main/CONTRIBUTING.md');
          },
        },
        {
          type: 'separator',
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/blockchiansea/nchain-blockchain/issues');
          },
        },
        {
  ...
  if (process.platform === 'darwin') {
    // NChain Blockchain menu (Mac)
    template.unshift({
      label: i18n._(/* i18n */ { id: 'NChain' }),
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'About NChain Blockchain' }),
          click: () => {
            openAbout();
          },
        },
