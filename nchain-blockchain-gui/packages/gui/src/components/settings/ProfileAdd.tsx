...
export default function ProfileAdd() {
  ...
  const currencyCode = (useCurrencyCode() ?? 'NCH').toUpperCase();
  const isTestnet = currencyCode === 'TNCH';
  ...
  function handleClick() {
    const url = `https://${isTestnet ? 'testnet0-faucet.ext9.org' : 'faucet.ext9.org'}/?address=${currentAddress}`;
    openExternal(url);
  }
