import { SyncingStatus } from '@nchain-network/api';
import { useExtendDerivationIndexMutation, useGetCurrentDerivationIndexQuery } from '@nchain-network/api-react';
import { AlertDialog, ButtonLoading, Flex, Form, TextField, useOpenDialog } from '@nchain-network/core';
import { useWalletState } from '@nchain-network/wallets';
