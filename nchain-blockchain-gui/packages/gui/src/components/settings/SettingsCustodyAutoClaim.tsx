import { useGetAutoClaimQuery, useSetAutoClaimMutation } from '@nchain-network/api-react';
import { Flex, SettingsText, Form, ButtonLoading, Fee, chiaToMojo, mojoToChia } from '@nchain-network/core';
import { ConnectCheckmark } from '@nchain-network/icons';
