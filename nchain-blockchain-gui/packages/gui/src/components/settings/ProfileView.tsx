...
import { useGetDIDQuery, useGetDIDNameQuery, useSetDIDNameMutation } from '@nchain-network/api-react';
import { Color, CopyToClipboard, Flex, Loading, Tooltip, truncateValue } from '@nchain-network/core';
