import { Flex, SettingsHR, SettingsSection, SettingsTitle, SettingsText } from '@nchain-network/core';
    ...
    <Grid container style={{ maxWidth: '624px' }} gap={3}>
      ...
      <Grid container>
        ...
        <Grid item container style={{ width: '400px' }} gap={2}>
          ...
          <FormHelperText>
            <Trans>Changes will take effect the next time NChain is started.</Trans>
          </FormHelperText>
        </Grid>
      </Grid>
