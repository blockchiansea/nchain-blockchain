import { useRefreshPlotsMutation } from '@nchain-network/api-react';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@nchain-network/core';
import { Plots } from '@nchain-network/icons';
