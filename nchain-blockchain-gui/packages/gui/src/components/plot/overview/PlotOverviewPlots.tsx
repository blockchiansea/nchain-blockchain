import { useRefreshPlotsMutation, useGetPlotDirectoriesQuery } from '@nchain-network/api-react';
import { Button, Flex, useOpenDialog, MenuItem, More } from '@nchain-network/core';
