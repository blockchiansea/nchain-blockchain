import { CardStep, ConfirmDialog, Link, Select, StateColor, useOpenDialog } from '@nchain-network/core';
    ...
    >
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/blockchiansea/nchain-blockchain/wiki/k-sizes">
            Learn more
          </Link>
        </Trans>
      </Typography>
