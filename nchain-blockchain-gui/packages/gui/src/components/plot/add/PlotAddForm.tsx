import { defaultPlotter, toBech32m, fromBech32m, WalletCreatePool } from '@nchain-network/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@nchain-network/api-react';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@nchain-network/core';
