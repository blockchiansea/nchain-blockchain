import { defaultPlotter, PlotterName } from '@nchain-network/api';
import type { Plotter, PlotterMap } from '@nchain-network/api';
import { useGetPlottersQuery } from '@nchain-network/api-react';
import { CardStep, Select, StateColor } from '@nchain-network/core';
