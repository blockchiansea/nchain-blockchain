import { type Plot } from '@nchain-network/api';
import { useGetHarvesterPlotsValidQuery, useGetHarvesterQuery } from '@nchain-network/api-react';
import { Address, TableControlled, Flex, FormatBytes, Tooltip, StateColor } from '@nchain-network/core';
