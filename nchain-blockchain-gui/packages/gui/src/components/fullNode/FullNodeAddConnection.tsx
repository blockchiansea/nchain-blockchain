import { useOpenFullNodeConnectionMutation } from '@nchain-network/api-react';
import { Button, ButtonLoading, DialogActions, Flex, Form, TextField, useShowError } from '@nchain-network/core';
