import { Connection } from '@nchain-network/api';
import { useGetFullNodeConnectionsQuery } from '@nchain-network/api-react';
import { Card, FormatBytes, FormatLargeNumber, IconButton, Loading, Table, useOpenDialog } from '@nchain-network/core';
