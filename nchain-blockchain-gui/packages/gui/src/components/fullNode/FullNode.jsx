import { useGetLatestBlocksQuery, useGetUnfinishedBlockHeadersQuery } from '@nchain-network/api-react';
import { FormatLargeNumber, Flex, Card, StateColor, Table, LayoutDashboardSub } from '@nchain-network/core';
import { Status } from '@nchain-network/icons';
