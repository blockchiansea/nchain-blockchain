import type { UnconfirmedPlotNFT } from '@nchain-network/api';
import { useGetTransactionQuery } from '@nchain-network/api-react';
import { Flex, Link, Loading } from '@nchain-network/core';
