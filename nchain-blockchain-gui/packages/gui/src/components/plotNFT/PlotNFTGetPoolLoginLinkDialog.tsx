import type { PlotNFT, PlotNFTExternal } from '@nchain-network/api';
import { useGetPoolLoginLinkQuery } from '@nchain-network/api-react';
import { Button, CopyToClipboard, Flex, Link, Loading } from '@nchain-network/core';
