import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@nchain-network/api-react';
import { Flex, State, Loading, StateTypography } from '@nchain-network/core';
