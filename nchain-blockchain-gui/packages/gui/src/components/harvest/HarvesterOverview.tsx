import { NewFarmingInfo } from '@nchain-network/api';
import { useGetBlockchainStateQuery, useGetHarvestersQuery, useGetNewFarmingInfoQuery } from '@nchain-network/api-react';
import { Flex, FormatBytes, FormatLargeNumber, CardSimple, useCurrencyCode } from '@nchain-network/core';
...
export default function HarvesterOverview() {
  ...
  const isTestnet = (useCurrencyCode() ?? 'NCH').toUpperCase() === 'TNCH';
