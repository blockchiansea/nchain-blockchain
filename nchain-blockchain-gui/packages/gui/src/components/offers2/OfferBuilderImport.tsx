import { useGetOfferSummaryMutation } from '@nchain-network/api-react';
import { Color, Dropzone, Flex, useSerializedNavigationState, useShowError } from '@nchain-network/core';
