...
import { useGetWalletsQuery } from '@nchain-network/api-react';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@nchain-network/core';
import { Tokens } from '@nchain-network/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>Chia Asset Tokens (CATs) are tokens built on top of NCH</Trans>}
