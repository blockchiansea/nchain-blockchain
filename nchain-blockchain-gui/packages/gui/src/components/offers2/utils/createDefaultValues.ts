...
type CreateDefaultValuesParams = {
  walletType?: WalletType; // CAT or STANDARD_WALLET (NCH), indicates whether a token or CAT has a default entry
 ...
 * for creating an NCH offer, a CAT offer, or an NFT offer. NCH and CAT offers will have a default entry in
...
export default function createDefaultValues(params: CreateDefaultValuesParams | undefined = {}): OfferBuilderData {
  ...
  return {
    ...
    offered: {
      ...
      nfts,
      nch: walletType === WalletType.STANDARD_WALLET ? [{ amount: '' }] : [],
