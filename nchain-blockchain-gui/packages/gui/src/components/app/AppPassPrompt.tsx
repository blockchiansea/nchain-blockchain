import { PassphrasePromptReason } from '@nchain-network/api';
import { useUnlockKeyringMutation, useGetKeyringStatusQuery } from '@nchain-network/api-react';
import { Button, Flex, TooltipIcon, useShowError, Loading, ButtonLoading, Form, TextField } from '@nchain-network/core';
