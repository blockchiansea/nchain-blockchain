import { Button, Flex } from '@nchain-network/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The NChain application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                Chia services version: {backV}
                <br />
                NChain application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the NChain application and stop all Chia services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
