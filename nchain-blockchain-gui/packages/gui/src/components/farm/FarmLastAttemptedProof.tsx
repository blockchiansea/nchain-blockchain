import { useGetNewFarmingInfoQuery } from '@nchain-network/api-react';
import { Link, Table, Card } from '@nchain-network/core';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/blockchiansea/nchain-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>
