import { Button, CardHero } from '@nchain-network/core';
import { Pooling } from '@nchain-network/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>Smooth out your NCH farming rewards by joining a pool.</Trans>
          </Typography>
