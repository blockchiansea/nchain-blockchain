...
import { useCreateOfferForIdsMutation, useGetWalletBalanceQuery } from '@nchain-network/api-react';
import {
  Amount,
  AmountProps,
  Back,
...
/*       An NFT offer consists of a single NFT being offered for NCH/CAT      */
/* ========================================================================== */
          ...
          <Box style={{ position: 'relative', top: '20px' }}>
            <TooltipIcon>
              <Trans>
                ...
                recommended minimum fee is 0.000005 NCH (5,000,000 mojos)
              </Trans>
            </TooltipIcon>
          </Box>
        </Flex>
...
/* ========================================================================== */
/*                              NFT Offer Editor                              */
/*           Currently only supports a single NFT <--> NCH/CAT offer          */
/* ========================================================================== */
