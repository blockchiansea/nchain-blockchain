...
import { MojoToChia } from '@nchain-network/core';
...
const walletConnectCommands: WalletConnectCommand[] = [
  ...
  },
  {
    ...
    params: [
      ...
      {
        name: WalletConnectCommandParamName.NCH_COINS,
        label: <Trans>NCH Coins</Trans>,
        type: 'object',
        isOptional: true,
      },
      {
        name: WalletConnectCommandParamName.NCH_CHANGE_TARGET,
        label: <Trans>NCH Change Target</Trans>,
        type: 'string',
        isOptional: true,
      },
      {
