...
test('Verify that a recipient wallet receives funds from sending wallet!', async () => {
  //Pre-requisites
  let receiveWallet = 'tnch17m0jla968szqmw7mf6msaea2jxl553g9m5kx8ryuqadvml8w49tq42uftq';
  let sendWallet = 'tnch1rkk6haccvw095t9ajc6h9tqekm2rz4zwurhep8dcrmsr2q2446zs9ehm66';
