# nchain-blockchain-gui/api-react
...
This library provides react hooks on the top of @nchain-network/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under the hood.
...
- Automatically refresh queries when data changed (using events from NChain Blockchain).
...
import { useGetPublicKeysQuery } from "@nchain-network/api-react";
import { Loading } from "@nchain-network/core";
...
import { store, api } from "@nchain-network/api-react";
