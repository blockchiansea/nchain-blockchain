...
import { CAT, DID, Farmer, NFT, Pool, WalletService, WalletType, toBech32m, VC } from '@nchain-network/api';
import type { NFTInfo, Transaction, Wallet, WalletBalance } from '@nchain-network/api';
