...
{
    Write-Output "NChain requires a 64-bit Windows installation"
    Exit 1
}
...
$supportedPythonVersions = "3.10", "3.9"
...
Write-Output ""
Write-Output "NChain blockchain .\Install.ps1 complete."
Write-Output "For assistance join us on Discord in the #support chat channel:"
Write-Output "https://discord.gg/chia"
Write-Output ""
Write-Output "Try the Quick Start Guide to running nchain-blockchain:"
...
Write-Output ""
Write-Output "Type '.\.venv\Scripts\Activate.ps1' and then 'nchain init' to begin."
