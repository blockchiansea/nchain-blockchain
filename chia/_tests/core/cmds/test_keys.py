...
class TestKeysCommands:
    def test_generate_with_new_config(self, tmp_path, empty_keyring):
        ...
        the correct nch_target_address entries.
        """
        ...
        # Verify that the config has the correct nch_target_address entries
        address_matches = re.findall(r"nch1[^\n]+", result.output)
        assert len(address_matches) > 1
        address = address_matches[0]

        config: Dict = load_config(tmp_path, "config.yaml")
        assert config["farmer"]["nch_target_address"] == address
        assert config["pool"]["nch_target_address"] == address
    ...
    def test_generate_with_existing_config(self, tmp_path, empty_keyring):
        ...
        the original nch_target_address entries.
        """
        ...
        assert existing_config["farmer"]["nch_target_address"] == address
        assert existing_config["pool"]["nch_target_address"] == address
        ...
        # Verify that the config's nch_target_address entries have not changed
        config: Dict = load_config(tmp_path, "config.yaml")
        assert config["farmer"]["nch_target_address"] == existing_config["farmer"]["nch_target_address"]
        assert config["pool"]["nch_target_address"] == existing_config["pool"]["nch_target_address"]
    ...
    def test_show_labels(self, empty_keyring, tmp_path):
        ...
        result = runner.invoke(cli, [*base_params, *cmd_params], catch_exceptions=False)
        assert result.output == "No keys are present in the keychain. Generate them with 'nchain keys generate'\n"
    ...
    def test_show(self, keyring_with_one_public_one_private_key, tmp_path):
        """
        Test that the `nchain keys show` command shows the correct key.
        """
    ...
    def test_show_fingerprint(self, keyring_with_one_public_one_private_key, tmp_path):
        """
        Test that the `nchain keys show --fingerprint` command shows the correct key.
        """
    ...
    def test_show_json(self, keyring_with_one_public_one_private_key, tmp_path):
        """
        Test that the `nchain keys show --json` command shows the correct key.
        """
    ...
    def test_show_mnemonic(self, keyring_with_one_public_one_private_key, tmp_path):
        """
        Test that the `nchain keys show --show-mnemonic-seed` command shows the key's mnemonic seed.
        """
    ...
    def test_show_mnemonic_json(self, keyring_with_one_public_one_private_key, tmp_path):
        """
        Test that the `nchain keys show --show-mnemonic-seed --json` command shows the key's mnemonic seed.
        """
    ...
    def test_generate_and_print(self):
        """
        Test the `nchain keys generate_and_print` command.
        """
    ...
    def test_sign(self, keyring_with_one_public_one_private_key):
        """
        Test the `nchain keys sign` command.
        """
    ...
    def test_sign_non_observer(self, keyring_with_one_public_one_private_key):
        """
        Test the `nchain keys sign` command with a non-observer key.
        """
    ...
    def test_verify(self):
        """
        Test the `nchain keys verify` command.
        """
    ...
    def test_derive_search(self, tmp_path, keyring_with_one_public_one_private_key):
        """
        Test the `nchain keys derive search` command, searching a public and private key
        """
    ...
    def test_derive_search_wallet_address(self, tmp_path, keyring_with_one_public_one_private_key):
        """
        Test the `nchain keys derive search` command, searching for a wallet address
        """
        ...
        assert (
            result.output.find(
                ...
                "nch1mnr0ygu7lvmk3nfgzmncfk39fwu0dv933yrcv97nd6pmrt7fzmhs3l4l8f (HD path: m/12381/8444/2/30)"
            )
            != -1
        )
        ...
        result: Result = runner.invoke(
            ...
            [
                ...
                "--search-type",
                "address",
                "nch1p33y7kv48u7l68m490mr8levl6nkyxm3x8tfcnnec555egxzd3gs37dccm",
            ],
        )
        ...
        assert (
            result.output.find(
                "Found wallet address: "
                "nch1p33y7kv48u7l68m490mr8levl6nkyxm3x8tfcnnec555egxzd3gs37dccm (HD path: m/12381/8444/2/9)"
            )
            != -1
        )
    ...
    def test_derive_search_wallet_testnet_address(self, tmp_path, keyring_with_one_public_one_private_key):
        """
        Test the `nchain keys derive search` command, searching for a testnet wallet address
        """
        ...
        result = runner.invoke(
            ...
            [
                ...
                "--search-type",
                "address",
                "tnch1mnr0ygu7lvmk3nfgzmncfk39fwu0dv933yrcv97nd6pmrt7fzmhsucjfx6",
                "--prefix",
                "tnch",
            ],
            catch_exceptions=False,
        ...
        assert (
            result.output.find(
                "Found wallet address: "
                "tnch1mnr0ygu7lvmk3nfgzmncfk39fwu0dv933yrcv97nd6pmrt7fzmhsucjfx6 (HD path: m/12381/8444/2/30)"
            )
            != -1
        )
        ...
        result: Result = runner.invoke(
            ...
            [
                ...
                "--search-type",
                "address",
                "tnch1p33y7kv48u7l68m490mr8levl6nkyxm3x8tfcnnec555egxzd3gsue2weg",
                "--prefix",
                "tnch",
            ],
        )
        ...
        assert (
            result.output.find(
                "Found wallet address: "
                "tnch1p33y7kv48u7l68m490mr8levl6nkyxm3x8tfcnnec555egxzd3gsue2weg (HD path: m/12381/8444/2/9)"
            )
            != -1
        )
    ...
    def test_derive_search_failure(self, tmp_path, keyring_with_one_public_one_private_key):
        """
        Test the `nchain keys derive search` command with a failing search.
        """
    ...
    def test_derive_search_hd_path(self, tmp_path, empty_keyring, mnemonic_seed_file):
        """
        Test the `nchain keys derive search` command, searching under a provided HD path.
        """
    ...
    def test_derive_wallet_address(self, tmp_path, keyring_with_one_public_one_private_key, mnemonic_seed_file):
        """
        Test the `nchain keys derive wallet-address` command, generating a couple of wallet addresses.
        """
        ...
        assert (
            result.output.find(
                ...
                "nch1jp2u7an0mn9hdlw2x05nmje49gwgzmqyvh0qmh6008yksetuvkfsv6tlry"
            )
            != -1
        )
        assert (
            result.output.find(
                ...
                "nch1006n6l3x5e8exar8mlj004znjl5pq0tq73h76kz0yergswnjzn8s20yl40"
            )
            != -1
        )
        ...
        assert (
            result.output.find(
                "Wallet address 9 (m/12381/8444/2/9): " "nch1p33y7kv48u7l68m490mr8levl6nkyxm3x8tfcnnec555egxzd3gs37dccm"
            )
            != -1
        )
    ...
    def test_derive_wallet_testnet_address(self, tmp_path, keyring_with_one_public_one_private_key):
        """
        Test the `nchain keys derive wallet-address` command, generating a couple of testnet wallet addresses.
        """
        ...
        assert (
            result.output.find(
                "Wallet address 50 (m/12381n/8444n/2n/50n): "
                "tnch1jp2u7an0mn9hdlw2x05nmje49gwgzmqyvh0qmh6008yksetuvkfspavfzh"
            )
            != -1
        )
        assert (
            result.output.find(
                "Wallet address 51 (m/12381n/8444n/2n/51n): "
                "tnch1006n6l3x5e8exar8mlj004znjl5pq0tq73h76kz0yergswnjzn8s8grf5u"
            )
            != -1
        )
    ...
    def test_derive_child_keys(self, tmp_path, keyring_with_one_public_one_private_key, mnemonic_seed_file):
        """
        Test the `nchain keys derive child-keys` command, generating a couple of derived keys.
        """
