...
@datacases(
    ...
    GetUnresolvedPeerInfosCase(
        ...
        expected_peer_infos={
            UnresolvedPeerInfo(host="127.0.0.1", port=uint16(58445)),
            UnresolvedPeerInfo(host="my.full-node.tld", port=uint16(18445)),
        },
    ),
    GetUnresolvedPeerInfosCase(
    ...
    GetUnresolvedPeerInfosCase(
        ...
        expected_peer_infos={
            UnresolvedPeerInfo(host="my.full-node.tld", port=uint16(18445)),
            UnresolvedPeerInfo(host="127.0.0.1", port=uint16(58445)),
            UnresolvedPeerInfo(host="my.other.full-node.tld", port=uint16(18445)),
        },
    ),
    GetUnresolvedPeerInfosCase(
