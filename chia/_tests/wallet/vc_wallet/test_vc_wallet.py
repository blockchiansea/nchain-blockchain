...
async def test_vc_lifecycle(wallet_environments: WalletTestFramework) -> None:
    ...
    wallet_0 = wallet_environments.environments[0].nch_wallet
    wallet_1 = wallet_environments.environments[1].nch_wallet
    ...
    wallet_1_addr = encode_puzzle_hash(wallet_1_ph, "tnch")
    txs = (
