...
# This method takes a dictionary of strings mapping to amounts and generates the appropriate CAT/NCH coins
...
async def test_complex_offer(cost_logger: CostLogger) -> None:
    async with sim_and_client() as (sim, sim_client):
        ...
        # Create yet another offer of BLUE for NCH and RED
        ...
        assert new_offer.summary() == (
            {"nch": 1000, str_to_tail_hash("red").hex(): 350, str_to_tail_hash("blue").hex(): 2000},
            {"nch": 900, str_to_tail_hash("red").hex(): 350},
