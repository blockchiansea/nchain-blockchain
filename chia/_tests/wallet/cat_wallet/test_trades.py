...
async def test_cat_trades(
    ...
    wallet_maker = env_maker.nch_wallet
    wallet_taker = env_taker.nch_wallet
        ...
        [
            WalletStateTransition(
                ...
                post_block_balance_updates={
                    "nch": {
                        "pending_coin_removal_count": -1,
                        "confirmed_wallet_balance": -2,  # One for offered NCH, one for fee
                        "unconfirmed_wallet_balance": -2,  # One for offered NCH, one for fee
                        ">#spendable_balance": 0,
                        ">#max_send_amount": 0,
                    },
                    "new cat": (
            ...
            WalletStateTransition(
                pre_block_balance_updates={
                    "nch": {
                        ...
                        "<=#spendable_balance": -2,
                        "<=#max_send_amount": -2,
                        # Unconfirmed balance doesn't change because receiveing 1 NCH and spending 1 in fee
                        "unconfirmed_wallet_balance": 0,
                ...
                post_block_balance_updates={
                    "nch": {
                        ...
                        ">#spendable_balance": 0,
                        ">#max_send_amount": 0,
                        # Confirmed balance doesn't change because receiveing 1 NCH and spending 1 in fee
                        "confirmed_wallet_balance": 0,
    ...
    nch_tx: TransactionRecord = next(tx for tx in action_scope.side_effects.transactions if tx.wallet_id == 1)
    assert nch_tx.amount == 3
    assert nch_tx.fee_amount == 1
...
async def test_trade_cancellation(wallet_environments: WalletTestFramework) -> None:
    ...
    cat_for_chia: OfferSummary = {
        env_maker.wallet_aliases["nch"]: 1,
        env_maker.wallet_aliases["cat"]: -2,
    }

    chia_for_cat: OfferSummary = {
        env_maker.wallet_aliases["nch"]: -3,
        ...
        [
            WalletStateTransition(
                pre_block_balance_updates={
                    ...
                    "cat": {
                        "spendable_balance": -nch_to_cat_amount,
                        "pending_change": nch_to_cat_amount,
                        "max_send_amount": -nch_to_cat_amount,
                        "pending_coin_removal_count": 1,
                    },
                },
                post_block_balance_updates={
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                pre_block_balance_updates={
                    "nch": {
                        "<=#spendable_balance": chia_for_cat[env_maker.wallet_aliases["nch"]],
                        "<=#max_send_amount": chia_for_cat[env_maker.wallet_aliases["nch"]],
                        ">=#pending_change": 1,
                        "pending_coin_removal_count": 1,
                    },
                    "cat": {},
    ...
    chia_and_cat_for_something: OfferSummary = {
        env_maker.wallet_aliases["nch"]: -5,
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                pre_block_balance_updates={
                    "nch": {
                        "<=#spendable_balance": chia_and_cat_for_something[env_maker.wallet_aliases["nch"]],
                        "<=#max_send_amount": chia_and_cat_for_something[env_maker.wallet_aliases["nch"]],
                        ">=#pending_change": 1,
                        "pending_coin_removal_count": 1,
                    },
                    "cat": {
...
async def test_trade_conflict(wallet_environments: WalletTestFramework) -> None:
    ...
    cat_for_chia: OfferSummary = {
        env_maker.wallet_aliases["nch"]: 1000,
        env_maker.wallet_aliases["cat"]: -4,
    }
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                ...
                post_block_balance_updates={
                    "nch": {
                        "unconfirmed_wallet_balance": cat_for_chia[env_maker.wallet_aliases["nch"]],
                        "confirmed_wallet_balance": cat_for_chia[env_maker.wallet_aliases["nch"]],
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "pending_change": 0,
                        "unspent_coin_count": 1,
            ...
            WalletStateTransition(
                pre_block_balance_updates={
                    "nch": {
                        "unconfirmed_wallet_balance": -cat_for_chia[env_maker.wallet_aliases["nch"]] - fee,
                        "<=#spendable_balance": -cat_for_chia[env_maker.wallet_aliases["nch"]] - fee,
                        "<=#max_send_amount": -cat_for_chia[env_maker.wallet_aliases["nch"]] - fee,
                        ">=#pending_change": 1,
                        "pending_coin_removal_count": 1,
                    },
                    "cat": {
                ...
                post_block_balance_updates={
                    "nch": {
                        "confirmed_wallet_balance": -cat_for_chia[env_maker.wallet_aliases["nch"]] - fee,
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "<=#pending_change": -1,
                        "pending_coin_removal_count": -1,
...
async def test_aggregated_trade_state(wallet_environments: WalletTestFramework) -> None:
    ...
    cat_for_chia: OfferSummary = {
        env_maker.wallet_aliases["nch"]: 2,
        env_maker.wallet_aliases["cat"]: -2,
    }
    chia_for_cat: OfferSummary = {
        env_maker.wallet_aliases["nch"]: -1,
    ...
    combined_summary: OfferSummary = {
        env_maker.wallet_aliases["nch"]: cat_for_chia[env_maker.wallet_aliases["nch"]]
        + chia_for_cat[env_maker.wallet_aliases["nch"]],
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                ...
                post_block_balance_updates={
                    "nch": {
                        "unconfirmed_wallet_balance": combined_summary[env_maker.wallet_aliases["nch"]],
                        "confirmed_wallet_balance": combined_summary[env_maker.wallet_aliases["nch"]],
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "pending_change": 0,
                        "unspent_coin_count": 1,
            ...
            WalletStateTransition(
                pre_block_balance_updates={
                    "nch": {
                        "unconfirmed_wallet_balance": -combined_summary[env_maker.wallet_aliases["nch"]],
                        "<=#spendable_balance": -combined_summary[env_maker.wallet_aliases["nch"]],
                        "<=#max_send_amount": -combined_summary[env_maker.wallet_aliases["nch"]],
                        ">=#pending_change": 1,
                        "pending_coin_removal_count": 1,
                    },
                    "cat": {
