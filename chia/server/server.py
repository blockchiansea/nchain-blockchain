...
class ChiaServer:
    ...
    def create(
        ...
        nchain_ca_crt_key: Tuple[Path, Path],
        name: str = __name__,
    ) -> ChiaServer:
        ...
        nchain_ca_crt_path, nchain_ca_key_path = nchain_ca_crt_key
        ...
        if local_type in authenticated_client_types:
            ...
            ssl_client_context = ssl_context_for_client(
                ca_cert=nchain_ca_crt_path,
                ca_key=nchain_ca_key_path,
    ...
    async def start(
        ...
        if self.webserver is not None:
            raise RuntimeError("NChainServer already started")
