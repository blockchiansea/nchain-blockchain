...
# the output will be printed to your chia root path, e.g. ~/.nchain/ext9/profile/
# to analyze the profile, run:

#   python chia/utils/profiler.py ~/.nchain/ext9/profile | less -r
...
#   python chia/utils/profiler.py ~/.nchain/ext9/profile 10 20
