...
# the new passphrase.
DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE = "$ nchain passphrase set # all the cool kids are doing it!"

MASTER_PASSPHRASE_SERVICE_NAME = "NChain Passphrase"
MASTER_PASSPHRASE_USER_NAME = "NChain Passphrase"
