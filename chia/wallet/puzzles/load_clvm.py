...
recompile_requested = (
    (os.environ.get("NCHAIN_DEV_COMPILE_CLVM_ON_IMPORT", "") != "") or ("pytest" in sys.modules)
) and os.environ.get("NCHAIN_DEV_COMPILE_CLVM_DISABLED", None) is None
...
def load_serialized_clvm(
    ...
    # Set the NCHAIN_DEV_COMPILE_CLVM_ON_IMPORT environment variable to anything except
