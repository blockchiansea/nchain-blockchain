...
After `nchain plots create` becomes obsolete, consider removing it from there.
"""
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "NChain Proof of Space", "version": chiapos_version, "installed": True}
