...
def generate(shell: str) -> None:
    ...
    You can source it directly (performs slower) by running:
        \033[3;33meval "$(nchain complete generate)"\033[0m
    or you can save the output to a file:
        \033[3;33mnchain complete generate > ~/.nchain-complete-bash\033[0m
    and source that file with:
        \033[3;33m. ~/.nchain-complete-bash\033[0m
    """
    ...
    subprocess.run(["chia"], check=True, env={**os.environ, "_NCHAIN_COMPLETE": f"{shell}_source"})
