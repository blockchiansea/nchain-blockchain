...
async def summary(
    ...
    if amounts is not None:
        print(f"Total nchain farmed: {amounts['farmed_amount'] / units['chia']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'nchain start wallet' and 'nchain wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'nchain wallet show'")
    else:
        print("Note: log into your key using 'nchain wallet show' to see rewards for each key")
