...
@click.group("sim", help="Configure and make requests to a NChain Simulator Full Node")
@click.option(
    "-p",
    "--rpc-port",
    help=(
...
@sim_cmd.command("create", help="Guides you through the process of setting up a NChain Simulator")
