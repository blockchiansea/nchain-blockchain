        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                if (
                    ...
                    print("Testnet0 constants missing. Adding to config...")
                ...
                testnet_port = "59445"
                testnet_introducer = "introducer-testnet0.ext9.org"
                testnet_dns_introducer = "dns-introducer-testnet0.ext9.org"
                bootstrap_peers = ["testnet0-node-us-west-2.ext9.org"]
                testnet = "testnet0"
                ...
                mainnet_port = "58445"
                mainnet_introducer = "introducer.ext9.org"
                mainnet_dns_introducer = "dns-introducer.ext9.org"
                bootstrap_peers = ["node.ext9.org"]
                net = "ext9"
