...
@click.option(
    "--proposal-minimum",
    help="The minimum amount (in nch) that a proposal must use to be created",
...
@click.option(
    "--fee-for-cat",
    help="Set the fees for the CAT creation transaction, in NCH.",
...
@click.option(
    "-a",
    "--amount",
    help="The amount of funds to send, in NCH or CATs",
    type=AmountParamType(),
    required=True,
)
@options.create_fee()
...
@click.option(
    "--asset-id",
    help="The asset id of the funds the proposal will send. Leave blank for nch",
    type=str,
    required=False,
    default=None,
)
